...
public class GamePlayManager {
    ...
    void updateGamePlay() {
        if(gameObjectManager.areAllEnemiesDestroyed()) {
    ...
    private void initializeLevel() {
        ...
        resetPositionsOfPlayerAndCarFriends();
        ...
        spawn(new HelicopterEnemy(gameView, this, gameObjectManager.helicopterPlayer, gameObjectManager.leadingCar1, gameObjectManager.leadingCar1.getposition().x, 300, currentLevel.speedHelicopterEnemy));
        ...
        spawn(new HelicopterEnemy(gameView, this, gameObjectManager.helicopterPlayer, gameObjectManager.leadingCar2, gameObjectManager.leadingCar2.getposition().x, 300, currentLevel.speedHelicopterEnemy));
        ...
        spawn(new HelicopterEnemy(gameView, this, gameObjectManager.helicopterPlayer, gameObjectManager.leadingCar3, gameObjectManager.leadingCar3.getposition().x, 300, currentLevel.speedHelicopterEnemy));
        ...
        spawn(new HelicopterEnemy(gameView, this, gameObjectManager.helicopterPlayer, gameObjectManager.leadingCar4, gameObjectManager.leadingCar4.getposition().x, 300, currentLevel.speedHelicopterEnemy));
    ...
    private void resetPositionsOfPlayerAndCarFriends() {
        gameObjectManager.helicopterPlayer.resetPosition();
