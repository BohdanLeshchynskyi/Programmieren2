...
public class HelicopterPlayer extends CollidableGameObject implements AutoMovable {
     ...
     * @param score reference of the score to keep track of it if the shot produced by the player hits an enemy
     */
    ...
    /**
     * getter method fpr player`s position.
    ...
    /**
     * resets player`s position to the starting one
     */
    public void resetPosition() {
        this.position.x = GameView.WIDTH / 2d;
        this.position.y = GameView.HEIGHT / 2d;
    }
}