...
class GameObjectManager {
    ...
    GameObjectManager(GameView gameView, GamePlayManager gamePlayManager) {
        ...
        //this.gameObjects.add(new JetEnemy(gameView, gamePlayManager, helicopterPlayer, leadingCar1, leadingCar1.getPosition().x + 10 * 11 * 3.5, 150));
        //this.gameObjects.add(new HelicopterEnemy(gameView, gamePlayManager, helicopterPlayer, leadingCar1, leadingCar1.getPosition().x + 5 * 11 * 3.5, 275));
        //this.gameObjects.add(new HelicopterEnemy(gameView, gamePlayManager, helicopterPlayer, leadingCar1, leadingCar1.getPosition().x, 300));
        ...
        //this.gameObjects.add(new JetEnemy(gameView, gamePlayManager, helicopterPlayer, leadingCar2, leadingCar2.getPosition().x + 10 * 11 * 3.5, 150));
        //this.gameObjects.add(new HelicopterEnemy(gameView, gamePlayManager, helicopterPlayer, leadingCar2, leadingCar2.getPosition().x + 5 * 11 * 3.5, 275));
        //this.gameObjects.add(new HelicopterEnemy(gameView, gamePlayManager, helicopterPlayer, leadingCar2, leadingCar2.getPosition().x, 300));
        ...
        //this.gameObjects.add(new JetEnemy(gameView, gamePlayManager, helicopterPlayer, leadingCar3, leadingCar3.getPosition().x + 10 * 11 * 3.5, 150));
        //this.gameObjects.add(new HelicopterEnemy(gameView, gamePlayManager, helicopterPlayer, leadingCar3, leadingCar3.getPosition().x + 5 * 11 * 3.5, 275));
        //this.gameObjects.add(new HelicopterEnemy(gameView, gamePlayManager, helicopterPlayer, leadingCar3, leadingCar3.getPosition().x, 300));
        ...
        //this.gameObjects.add(new JetEnemy(gameView, gamePlayManager, helicopterPlayer, leadingCar4, leadingCar4.getPosition().x + 10 * 11 * 3.5, 150));
        //this.gameObjects.add(new HelicopterEnemy(gameView, gamePlayManager, helicopterPlayer, leadingCar4, leadingCar4.getPosition().x + 5 * 11 * 3.5, 275));
        //this.gameObjects.add(new HelicopterEnemy(gameView, gamePlayManager, helicopterPlayer, leadingCar4, leadingCar4.getPosition().x, 300));
